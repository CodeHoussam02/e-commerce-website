...
export default function Dealscard({reviews, img, title, price, old, alert, alertMsg}) {
    const [stars, setStars] = useState()
    return <>
        <div className="max-w-[450px] max-h-[370px] rounded-md overflow-hidden cursor-pointer group">
            <div className='bg-[#f5f5f5] min-h-[270px] grid place-content-center relative overflow-hidden '>
                {/* {
                    !alert ?
            ...
            <p className='font-medium my-2 flex items-center'>
                ...
                {
                    old && <span className='text-sm text-gray-400'>${old}</span>
                }
            </p>
            <div className='flex'>
                <div>
