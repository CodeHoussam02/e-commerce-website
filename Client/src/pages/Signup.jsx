...
const Signup = _ => {
    return <section className="mt-[70px] px-[120px] h-[55rem] mb-[70px]">
            ...
            <div>
                <form className="my-12">
                    <div className="ring-1 ring-gray-300 mb-4 w-[28rem] mx-auto relative p-1 rounded-md">
                        ...
                        <input type="text" className="border-none w-[24rem] focus:ring-0 text-lg placeholder:font-semibold placeholder-gray-400" placeholder="Your name"/>
                    </div>
                    <div className="ring-1 ring-gray-300 mb-4 w-[28rem] mx-auto relative p-1 rounded-md">
                ...
                <div className="text-center">
                    ...
                    <h2 className="font-semibold text-gray-400 cursor-pointer">Already have an account? 
                        <Link to='/login' className="ml-1 text-black hover:underline">Log in</Link>
                    </h2>
                </div>
            </div>
        </div>
